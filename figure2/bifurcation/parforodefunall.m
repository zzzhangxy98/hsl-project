...
n1=2;n2=2;
% ux=opt.ux;uy=opt.uy;
dxdt=(r0x+r1.*k1.*x.^n1+0*r2.*k2.*y.^n2+r3.*k3.*x.^n1.*y.^n2)./(1+k1.*x.^n1+k2.*y.^n2+k3.*x.^n1.*y.^n2)-d1.*x;
dydt=(r0y+0*r5.*k5.*x.^n1+r4.*k4.*y.^n2+r6.*k6.*x.^n1.*y.^n2)./(1+k5.*x.^n1+k4.*y.^n2+k6.*x.^n1.*y.^n2)-d2.*y;
F=[dxdt;dydt];
end
